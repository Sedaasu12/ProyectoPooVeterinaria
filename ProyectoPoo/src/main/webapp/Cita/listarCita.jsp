						...
						<div class="modal-content">
							...
							<form action="CitaController" method="post">
								<input type="hidden" name="op" value="actualizar"> <input
									type="hidden" name="idCita" value="<%=c.getIdCita()%>">

								<div class="modal-body row g-3">

									<div class="col-md-6">
										<label>Mascota:</label> <select name="idMascota"
											class="form-select">
											<%
									...
									<div class="col-md-6">
										<label>Servicio:</label> <select name="idServicio"
											class="form-select">
											<%
									...
									<div class="col-md-6">
										<label>Fecha:</label> <input type="date" class="form-control"
											name="fecha" value="<%=c.getFecha()%>">
									</div>

									<div class="col-md-6">
										<label>Hora:</label> <input type="time" class="form-control"
											name="hora" value="<%=c.getHora()%>">
									</div>
						...
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a class="btn btn-danger"
									href="CitaController?op=eliminar&id=<%=c.getIdCita()%>">Eliminar</a>
							</div>
			...
			<div class="modal-content">
				...
				<form action="CitaController" method="post">
					...
					<div class="modal-body row g-3">
						...
						<div class="col-md-6">
							<label>Estado:</label> <select name="estado" class="form-select"
								required>
								<option value="">Seleccione</option>
